...
if lightline#colorscheme#background() ==# 'light'
  ...
  " Dark variant
  let s:bg     = [ '#282c34', 235 ]
  let s:gray0 = ['#000000', 0]
  let s:gray1  = [ '#5c6370', 241 ]
  let s:gray2  = [ '#2c323d', 235 ]
  let s:gray3  = [ '#3e4452', 240 ]
  let s:red3   = [ '#DC143C', 168 ]

  let s:p.normal.left     = [ [ s:bg, s:yellow, 'bold' ], [ s:fg, s:gray0 ] , [ s:purple, s:gray0 ] ,  [ s:red3, s:gray0 ] , [ s:blue, s:gray0 ] ]
  let s:p.normal.middle   = [ [ s:fg, s:gray2 ] ]
  let s:p.inactive.left   = [ [ s:gray1,  s:bg ], [ s:gray1, s:bg ] ]
  let s:p.inactive.middle = [ [ s:gray1, s:gray2 ] ]
  let s:p.inactive.right  = [ [ s:gray1, s:bg ], [ s:gray1, s:bg ] ]
  let s:p.insert.left     = [ [ s:bg, s:purple, 'bold' ], [ s:fg, s:gray0 ] , [ s:purple, s:gray0 ] ,  [ s:red3, s:gray0 ] , [ s:blue, s:gray0 ] ]
  let s:p.replace.left    = [ [ s:bg, s:red1, 'bold' ], [ s:fg, s:gray0 ] , [ s:purple, s:gray0 ] ,  [ s:red3, s:gray0 ] , [ s:blue, s:gray0 ] ]
  let s:p.visual.left     = [ [ s:bg, s:blue, 'bold' ], [ s:fg, s:gray0 ] , [ s:purple, s:gray0 ] ,  [ s:red3, s:gray0 ] , [ s:blue, s:gray0 ] ]
endif

" Common
let s:p.normal.right   = [ [ s:bg, s:yellow, 'bold' ], [ s:bg, s:yellow, 'bold' ] , [ s:fg, s:gray0, 'bold' ]]
let s:p.normal.error   = [ [ s:red2,   s:bg ] ]
let s:p.normal.warning = [ [ s:yellow, s:bg ] ]
let s:p.insert.right   = [ [ s:bg, s:purple, 'bold' ], [ s:bg, s:purple, 'bold' ] , [ s:fg, s:gray0, 'bold' ]]
let s:p.replace.right  = [ [ s:bg, s:red1, 'bold' ], [ s:bg, s:red1, 'bold' ] , [ s:fg, s:gray0, 'bold' ]]
let s:p.visual.right   = [ [ s:bg, s:blue, 'bold' ], [ s:bg, s:blue, 'bold' ] , [ s:fg, s:gray0, 'bold' ]]
